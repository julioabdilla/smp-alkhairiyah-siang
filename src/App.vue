<template>
  <div class="font-helvetica min-h-screen">
    <div id="banner" class="flex flex-col">
      ...
      <div class="mb-auto grid grid-cols-6 md:flex nav mx-none md:mx-auto p-2 rounded-none md:rounded-full mt-2 md:mt-[-0.4rem] z-0 md:z-10 border-none md:border border-white text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-base">
